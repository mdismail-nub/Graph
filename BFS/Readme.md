...
- For a **disconnected graph**, run BFS from every unvisited node to traverse all components.

---

## 📖 Resources

- **Video Explanation:** https://youtu.be/-tgVpUgsQ5k?si=tZ1qp4Ij2BmqnbTI
- **Practice Problem (GeeksforGeeks):** https://www.geeksforgeeks.org/problems/bfs-traversal-of-graph/1
